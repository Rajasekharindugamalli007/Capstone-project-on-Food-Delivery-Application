    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.jsp" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
            </li>
                <li class="no-padding">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
                                    ...
                                    -->
									"><a href="all-orders.jsp">All Orders</a>
                                </li>
                                        <!--
								<?php
                                    ...
                                    echo '<li class='.(isset($_GET['status'])?($status == $_GET['status'] ? 'active' : ''): '').'><a href="all-orders.jsp?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                        -->
					...
					%>				
                                            <li class='active' ><a href="all-orders.jsp?status='<%=rs.getString("status")%>'"><%=rs.getString("status")%></a>
                                    </li>
                                    <%
                        }
                 ...
                 <li class="no-padding">
                            ...
                            <div class="collapsible-body">
								...
								<?php
                                    ...
                                    -->                                    
                                        ...
                                        String sql1 = "SELECT DISTINCT status FROM tickets";
					...
					%>				
                                            <li class='active' ><a href="all-tickets.jsp?status='<%=rs1.getString("status")%>'"><%=rs1.getString("status")%></a>
                                    </li>
                                    <%
                        }
