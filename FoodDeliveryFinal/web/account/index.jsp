    ...
    <div class="wrapper">
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.jsp" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Food</a>
				...
				<%
                                    ...
                                    String sql11="SELECT DISTINCT status FROM orders WHERE customer_id = "+user_id1;
                                    ResultSet rss=stt1.executeQuery(sql11);
				   
				while(rss.next()){
                                    %>
                                    <li><a href='orders.jsp?status=<%=rss.getString("status")%>'><%=rs.getString("status")%> </a>
                                    </li>
                                    <%
									}
									%>
								...
								<?php
                                    ...
                                    echo '<li><a href="orders.jsp?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="tickets.jsp">All Tickets</a>
                                </li>
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM tickets WHERE poster_id = $user_id AND not deleted;");
									while($row = mysqli_fetch_array($sql)){
                                    echo '<li><a href="tickets.jsp?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.jsp" novalidate="novalidate">
            <div class="row">
